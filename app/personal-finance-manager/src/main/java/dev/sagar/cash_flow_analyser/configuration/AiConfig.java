...
public class AiConfig {
    ...
    public ChatClient geminiOpenaiChatClient(GeminiAiProperties geminiAiProperties) {
        ReactorClientHttpRequestFactory requestFactory = new ReactorClientHttpRequestFactory();
        requestFactory.setReadTimeout(Duration.ofSeconds(geminiAiProperties.getReadTimeout()));
        ...
        return ChatClient.builder(OpenAiChatModel.builder()
                ...
                .defaultOptions(OpenAiChatOptions.builder().model(geminiAiProperties.getModel())
