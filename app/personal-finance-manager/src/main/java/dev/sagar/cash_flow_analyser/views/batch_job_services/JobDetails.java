...
record JobDetails(String status, Long jobExecutionId,
    @JsonInclude(Include.NON_NULL) Long jobInstanceId, String jobName,
  ...
  public JobDetails(String status, Long jobExecutionId, Long jobInstanceId,
      String jobName, LocalDateTime startTime) {
